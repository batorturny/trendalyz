...
const chartCatalog = [
    ...
    { key: 'tiktokads_ad_performance', title: 'Hirdetések teljesítménye', description: 'Hirdetések részletes teljesítménye', category: CHART_CATEGORIES.ADS, type: 'table', color: '#00d4ff', platform: 'TIKTOK_ADS', windsorFields: ['ad_name', 'ad_text', 'impressions', 'clicks', 'spend', 'cpc', 'ctr', 'video_play_actions', 'video_watched_2s', 'average_video_play'] },
