...
const chartCatalog = [
    ...
    { key: 'tiktokads_daily_spend', title: 'Napi költés', description: 'Napi hirdetési költés', category: CHART_CATEGORIES.ADS, type: 'bar', color: '#ff6b9d', platform: 'TIKTOK_ADS', windsorFields: ['spend', 'date'] },
    { key: 'tiktokads_daily_impressions', title: 'Napi megjelenítések', description: 'Napi impressziók száma', category: CHART_CATEGORIES.ADS, type: 'bar', color: '#4d96ff', platform: 'TIKTOK_ADS', windsorFields: ['impressions', 'date'] },
    { key: 'tiktokads_daily_clicks', title: 'Napi kattintások', description: 'Napi kattintások száma', category: CHART_CATEGORIES.ADS, type: 'bar', color: '#bc6aff', platform: 'TIKTOK_ADS', windsorFields: ['clicks', 'date'] },
    { key: 'tiktokads_daily_reach', title: 'Napi elérés', description: 'Napi elérés száma', category: CHART_CATEGORIES.ADS, type: 'bar', color: '#00d4aa', platform: 'TIKTOK_ADS', windsorFields: ['reach', 'date'] },
    { key: 'tiktokads_daily_ctr', title: 'Napi CTR', description: 'Napi átkattintási arány', category: CHART_CATEGORIES.ADS, type: 'line', color: '#00ff95', platform: 'TIKTOK_ADS', windsorFields: ['ctr', 'date'] },
    { key: 'tiktokads_daily_cpc', title: 'Napi CPC', description: 'Napi kattintásonkénti költség', category: CHART_CATEGORIES.ADS, type: 'line', color: '#ffce44', platform: 'TIKTOK_ADS', windsorFields: ['cpc', 'date'] },
    { key: 'tiktokads_daily_cpm', title: 'Napi CPM', description: 'Napi ezres megjelenésenkénti költség', category: CHART_CATEGORIES.ADS, type: 'line', color: '#9d4edd', platform: 'TIKTOK_ADS', windsorFields: ['cpm', 'date'] },
    { key: 'tiktokads_daily_engagement', title: 'Napi engagement', description: 'Napi like-ok, kommentek és megosztások', category: CHART_CATEGORIES.ADS, type: 'bar', color: '#bc6aff', platform: 'TIKTOK_ADS', windsorFields: ['likes', 'comments', 'shares', 'date'] },
    { key: 'tiktokads_daily_follows', title: 'Napi új követők', description: 'Napi új követők hirdetésekből', category: CHART_CATEGORIES.ADS, type: 'bar', color: '#00ff95', platform: 'TIKTOK_ADS', windsorFields: ['follows', 'date'] },
    { key: 'tiktokads_daily_conversions', title: 'Napi konverziók', description: 'Napi konverziók száma', category: CHART_CATEGORIES.ADS, type: 'bar', color: '#00d4aa', platform: 'TIKTOK_ADS', windsorFields: ['conversions', 'date'] },
    { key: 'tiktokads_ad_performance', title: 'Hirdetések teljesítménye', description: 'Hirdetések részletes teljesítménye videónként', category: CHART_CATEGORIES.ADS, type: 'table', color: '#00d4ff', platform: 'TIKTOK_ADS', windsorFields: ['ad_name', 'ad_text', 'impressions', 'clicks', 'spend', 'cpc', 'ctr', 'reach', 'conversions', 'video_play_actions', 'video_watched_2s', 'video_watched_6s', 'average_video_play', 'likes', 'comments', 'shares'] },
    { key: 'tiktokads_campaign_performance', title: 'Kampány teljesítmény', description: 'Kampányok összesített teljesítménye', category: CHART_CATEGORIES.ADS, type: 'table', color: '#4d96ff', platform: 'TIKTOK_ADS', windsorFields: ['campaign_name', 'impressions', 'clicks', 'spend', 'cpc', 'ctr', 'reach', 'video_play_actions'] },
