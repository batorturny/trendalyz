    ...
    <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-4 md:p-6 shadow-[var(--shadow-card)]">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          onClick={handleSave}
          disabled={isPending}
          className="flex items-center gap-2 bg-gradient-to-r from-[#1a6b8a] to-[#0d3b5e] text-white dark:text-[var(--surface)] font-bold py-2 px-4 rounded-xl hover:from-[#8ec8d8] hover:to-[#1a6b8a] active:scale-[0.97] disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-150"
        >
          {isPending ? (
