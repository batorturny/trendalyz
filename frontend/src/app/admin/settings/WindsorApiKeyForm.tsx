    ...
    <div className="bg-[var(--surface-raised)] rounded-2xl border border-[var(--border)] p-6 space-y-4">
      ...
      <div className="flex gap-3">
        <button
          ...
          className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#1a6b8a] to-[#0d3b5e] text-white dark:text-[var(--surface)] text-sm font-semibold disabled:opacity-50 hover:from-[#8ec8d8] hover:to-[#1a6b8a] transition-all flex items-center gap-2"
        >
