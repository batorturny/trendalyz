...
export function PlatformIcon({ platform, className = 'w-5 h-5' }: Props) {
  switch (platform) {
    case 'tiktok':
      return (
...
export function getPlatformFromProvider(provider: string): 'tiktok' | 'facebook' | 'instagram' | 'youtube' {
