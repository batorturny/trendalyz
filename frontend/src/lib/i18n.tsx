...
const translations = {
  ...
  'Bejelentkezés email-linkkel': 'Sign in with email link',
  'Add meg az email címed és küldünk egy egyszer használatos belépési linket.': 'Enter your email and we will send you a one-time sign-in link.',
  'Belépési link küldése': 'Send sign-in link',
  'Adminoknak: belépés jelszóval': 'Admin: sign in with password',
  'Belépés jelszóval': 'Sign in with password',
  'Csak admin fiókokhoz': 'Admin accounts only',
  'Vissza az email-linkhez': 'Back to email link',
  'Az email-alapú belépés most nem elérhető. Kérlek, használd a jelszavas belépést.': 'Email-based sign-in is currently unavailable. Please use password sign-in.',
  'Elküldtük a belépési linket. Nézd meg a postaládád!': 'We sent you a sign-in link. Check your inbox!',
  'Nem sikerült elküldeni a belépési linket': 'Failed to send sign-in link',
  ...
  'Videók láthatósága': 'Video visibility',
  'Videók betöltése...': 'Loading videos...',
