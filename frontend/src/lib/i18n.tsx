...
const translations = {
  ...
  'A név nem lehet üres': 'Name cannot be empty',
  'Átnevezés sikertelen': 'Rename failed',
  ...
  'Aktuális hónap': 'Current month',
  'IDŐSZAK': 'PERIOD',
  'Válassz hónapot...': 'Select month...',

  // Platform report page
  'Cég kiválasztása': 'Select company',
  'CÉG KIVÁLASZTÁSA': 'SELECT COMPANY',
  'HÓNAP': 'MONTH',
  'Válassz céget...': 'Select company...',
  'Összes cég': 'All companies',

  // KPI labels — TikTok Ads (chartHelpers / platformMetrics)
  'Költés': 'Spend',
  'Költés (Ft)': 'Spend (HUF)',
  'Kattintások': 'Clicks',
  'CPC (kattintás ára)': 'CPC (cost per click)',
  'CPM (1000 megj. ára)': 'CPM (cost per 1K impressions)',
  'Konverziók': 'Conversions',
  'Költség/konverzió': 'Cost/conversion',
  'Konverziós arány%': 'Conversion rate%',
  'Költés/kattintás': 'Cost/click',
  'CPR (1000 elérés ára)': 'CPR (cost per 1K reach)',
  'CPR (1000 elérés)': 'CPR (cost per 1K reach)',
  'App telepítések': 'App installs',
  'Fizetés konverziók': 'Payment conversions',
  'Regisztrációk': 'Registrations',
  'Költés trend': 'Spend trend',
  'Impressziók & kattintások': 'Impressions & clicks',
  'CPC & CPM': 'CPC & CPM',
  'Videó engagement': 'Video engagement',
  'Elérési költség (CPR)': 'Reach cost (CPR)',
  'Átl. videó lejátszás': 'Avg. video playback',
  'Kampány teljesítmény': 'Campaign performance',
  'Hirdetéscsoport teljesítmény': 'Ad group performance',

  // KPI labels — TikTok Organic
  'Profil nézések': 'Profile views',
  'Profilnézetek': 'Profile views',
  'Bio link kattintások': 'Bio link clicks',
  'Bio link kattintás': 'Bio link clicks',
  'Email kattintások': 'Email clicks',
  'Telefonszám kattintások': 'Phone clicks',
  'Napi új like-ok': 'Daily new likes',
  'Össz. követőnövekedés': 'Total follower growth',
  'Összes követő': 'Total followers',
  'Össz. megtekintés': 'Total views',
  'Like-ok': 'Likes',
  'Like / megtekintés': 'Likes / views',
  'Komment / megtekintés': 'Comments / views',
  'Megosztás / megtekintés': 'Shares / views',
  'Összes interakció': 'Total interactions',
  'Átl. megtekintés/videó': 'Avg. views/video',
  'Átl. like/videó': 'Avg. likes/video',
  'Átl. komment/videó': 'Avg. comments/video',
  'Átl. megosztás/videó': 'Avg. shares/video',
  'Átl. nézési idő (mp)': 'Avg. watch time (sec)',
  'Átl. végignézés%': 'Avg. full watch%',
  'Átl. új követő/videó': 'Avg. new followers/video',
  'Össz. elérés': 'Total reach',
  'Videók száma': 'Number of videos',
  'ER%': 'ER%',
  'Napi követők trend': 'Daily followers trend',
  'Összes követő trend': 'Total followers trend',
  'Napi like-ok': 'Daily likes',
  'Napi kommentek': 'Daily comments',
  'Napi megosztások': 'Daily shares',
  'Követő változás ±': 'Follower change ±',
  'Engagement napok szerint': 'Engagement by day',
  'Engagement órák szerint': 'Engagement by hour',
  'Forgalmi források': 'Traffic sources',
  'Életkori megoszlás': 'Age distribution',
  'Nemek megoszlása': 'Gender distribution',
  'Közönség országok': 'Audience countries',
  'Közönség városok': 'Audience cities',
  'Összes videó': 'All videos',
  'Top 3 videó': 'Top 3 videos',
  'Leggyengébb 3 videó': 'Worst 3 videos',

  // KPI labels — Facebook
  'Reakciók (posztok)': 'Reactions (posts)',
  'Kommentek (posztok)': 'Comments (posts)',
  'Megosztások (posztok)': 'Shares (posts)',
  'Posztok': 'Posts',
  'Oldal megtekintések': 'Page views',
  'Reakció / elérés': 'Reactions / reach',
  'Engagement rate%': 'Engagement rate%',
  'Átl. elérés/poszt': 'Avg. reach/post',
  'Átl. reakció/poszt': 'Avg. reactions/post',
  'Átl. komment/poszt': 'Avg. comments/post',
  'Átl. megosztás/poszt': 'Avg. shares/post',
  'Átl. kattintás/poszt': 'Avg. clicks/post',
  'Organikus impressziók': 'Organic impressions',
  'Fizetett impressziók': 'Paid impressions',
  'Oldal akciók': 'Page actions',
  'Reels lejátszások': 'Reels plays',
  'Oldal elérés': 'Page reach',
  'Követők trend': 'Followers trend',
  'Poszt engagement': 'Post engagement',
  'Követők változás': 'Followers change',
  'Videó nézési idő': 'Video watch time',
  'Organikus vs fizetett': 'Organic vs paid',
  'Kattintás típusok': 'Click types',
  'Reakció megoszlás': 'Reaction distribution',
  'Követők országonként': 'Followers by country',
  'Követők városonként': 'Followers by city',
  'Összes poszt': 'All posts',
  'Top 3 poszt': 'Top 3 posts',
  'Leggyengébb 3 poszt': 'Worst 3 posts',
  'Reel teljesítmény': 'Reel performance',

  // KPI labels — Instagram
  'Mentések': 'Saves',
  'Tartalmak': 'Content',
  'Mentési arány': 'Save rate',
  'Story elérés': 'Story reach',
  'Like / elérés': 'Likes / reach',
  'Átl. elérés/tartalom': 'Avg. reach/content',
  'Átl. like/tartalom': 'Avg. likes/content',
  'Átl. komment/tartalom': 'Avg. comments/content',
  'Átl. mentés/tartalom': 'Avg. saves/content',
  'Átl. megosztás/tartalom': 'Avg. shares/content',
  'Weboldal kattintások': 'Website clicks',
  'Összes profil kattintás': 'Total profile clicks',
  'Elérés & impressziók': 'Reach & impressions',
  'Profil aktivitás': 'Profile activity',
  'Story áttekintés': 'Story overview',
  'Story interakciók': 'Story interactions',
  'Story navigáció': 'Story navigation',
  'Profil kattintások': 'Profile clicks',
  'Összes tartalom': 'All content',
  'Top 3 tartalom': 'Top 3 content',

  // YouTube
  'Feliratkozók': 'Subscribers',
  'Új feliratkozók': 'New subscribers',
  'Összes feliratkozó': 'Total subscribers',
  'Nézések': 'Views',
  'Megtekintések': 'Views',
  'Nézési idő (óra)': 'Watch time (hours)',
  'Nézési idő': 'Watch time',
  'Átl. nézési idő': 'Avg. view duration',
  'Videók': 'Videos',
  'Nézési%': 'View %',
  'Átl. nézési %': 'Avg. view %',
  'Playlist hozzáadás': 'Playlist adds',
  'Átl. nézési idő/videó': 'Avg. watch time/video',
  'Átl. ER%/videó': 'Avg. ER%/video',
  'Kártya kattintások': 'Card clicks',
  'Kártya CTR%': 'Card CTR%',
  'Premium nézési idő': 'Premium watch time',
  'Feliratkozók trend': 'Subscribers trend',
  'Engagement rate': 'Engagement rate',
  'Premium nézések': 'Premium views',
  'Like-ok & dislike-ok': 'Likes & dislikes',
  'Kártya teljesítmény': 'Card performance',
  'Közzétett videók': 'Published videos',
  'Playlist eltávolítás': 'Playlist removes',
  'Kártya CTR': 'Card CTR',
  'Top országok': 'Top countries',
  'Top 5 videó': 'Top 5 videos',
  'Leggyengébb 5 videó': 'Worst 5 videos',

  // VideoTable
  'Nincs videó ebben a hónapban': 'No video this month',
  'Nincs videó adat': 'No video data',

  // Misc UI
  'Véglegesítés': 'Confirm',
  'Bezárás': 'Close',
  'Új cég hozzáadása': 'Add new company',
  'Fiók inaktív': 'Account inactive',
  'Nincs megjeleníthető riport tartalom': 'No displayable report content',
  'Válassz céget és hónapot, majd generáld a riportot': 'Select a company and month, then generate the report',
  'Válassz céget!': 'Select a company!',
  'Nincsenek elérhető chartok ehhez a platformhoz': 'No charts available for this platform',
  'Nem sikerült betölteni az adatokat': 'Failed to load data',
  'Egyik cégnek sincs adata ezen a platformon a kiválasztott hónapban': 'None of the companies have data on this platform for the selected month',
  'Válassz céget és legalább egy chartot!': 'Select a company and at least one chart!',
  'Ország': 'Country',
  'Város': 'City',
  'Kategória': 'Category',
  'CTR trend': 'CTR trend',
