...
export const PLATFORM_METRICS: Record<string, PlatformMetricConfig> = {
  ...
  TIKTOK_ADS: {
    ...
    platform: 'tiktok',
    kpis: [
      { key: 'ttads_spend', label: 'Költés (Ft)', chartKeys: ['ttads_spend_trend'] },
      ...
      { key: 'ttads_cpc', label: 'CPC (kattintás ára)', chartKeys: ['ttads_cpc_cpm'] },
      { key: 'ttads_cpm', label: 'CPM (1000 megj. ára)', chartKeys: ['ttads_cpc_cpm'] },
      ...
      { key: 'ttads_cpr', label: 'CPR (1000 elérés ára)', chartKeys: ['ttads_reach_cost'] },
  ...
  INSTAGRAM_ORGANIC: {
    ...
    platform: 'instagram',
    kpis: [
      { key: 'ig_followers', label: 'Követők', chartKeys: ['ig_daily_followers'] },
      ...
      { key: 'ig_new_followers', label: 'Új követők', chartKeys: ['ig_follower_growth'] },
    ...
    daily: [
      ...
      { key: 'ig_follower_growth', label: 'Új követők', chartKeys: ['ig_follower_growth'] },
      { key: 'ig_daily_followers', label: 'Összes követő', chartKeys: ['ig_daily_followers'] },
  ...
  YOUTUBE: {
    ...
    daily: [
      ...
      { key: 'yt_daily_views', label: 'Napi nézések', chartKeys: ['yt_daily_views'] },
      { key: 'yt_daily_watch_time', label: 'Napi nézési idő', chartKeys: ['yt_daily_watch_time'] },
      { key: 'yt_daily_subscribers', label: 'Napi feliratkozók', chartKeys: ['yt_daily_subscribers'] },
      { key: 'yt_daily_likes', label: 'Napi kedvelések', chartKeys: ['yt_daily_likes'] },
      { key: 'yt_daily_comments', label: 'Napi kommentek', chartKeys: ['yt_daily_comments'] },
      { key: 'yt_daily_shares', label: 'Napi megosztások', chartKeys: ['yt_daily_shares'] },
      { key: 'yt_avg_view_pct_trend', label: 'Átl. megtekintési %', chartKeys: ['yt_avg_view_pct_trend'] },
