...
const KPI_DESC: Record<string, { title: string; text: string; tip: string }> = {
  ...
  tt_daily_reached_total: { title: 'Napi elért közönség', text: 'Az adott időszakban naponta elért egyedi felhasználók összesítése. Ez a fiók általános láthatóságának egyik legfontosabb mutatója, mert megmutatja, hány ember találkozik naponta a tartalmaiddal.', tip: 'A napi elérés növeléséhez rendszeresen posztolj, használj trendi hashtageket és hangokat, és figyelj a posztolási időpontokra. A magas engagement-ű videók automatikusan több embert érnek el.' },
  tt_engaged_total: { title: 'Elkötelezett közönség', text: 'Az adott időszakban interakcióba lépő egyedi felhasználók napi összesítése. Ez a valódi, aktív közönséged méretét mutatja — nem azokat, akik csak látták a tartalmadat, hanem akik reagáltak rá.', tip: 'Az elkötelezett közönség növeléséhez készíts interaktív tartalmakat: kérdések, kihívások, szavazások. Válaszolj a kommentekre és építs közösséget a fiókod körül.' },
  tt_email_clicks_total: { title: 'Email kattintások', text: 'A profilodban megadott email cím kattintásainak összesítése. Ez közvetlenül méri, hogy hányan akarják felvenni veled a kapcsolatot emailen keresztül — fontos konverziós mutató üzleti fiókok számára.', tip: 'Utalj a videóidban az email elérhetőségre, különösen együttműködési és üzleti ajánlatoknál. A bio szövegében is jelezd, hogy elérhető vagy emailen.' },
  tt_phone_clicks_total: { title: 'Telefonszám kattintások', text: 'A profilodban megadott telefonszám kattintásainak összesítése. Ez a közvetlen kapcsolatfelvételi szándék mutatója, különösen fontos helyi szolgáltatók és vállalkozások számára.', tip: 'Szolgáltató vállalkozásoknál a telefonos elérhetőség megadása a profilban közvetlenül hozhat ügyfeleket. Utalj a videóidban a közvetlen kapcsolatfelvétel lehetőségére.' },
  // TikTok Ads
  ...
  ttads_cpr: { title: 'CPR (1000 elérés)', text: '1000 elért felhasználóra jutó költség. A CPR a márkaismeretségi kampányok hatékonyságának egyik fő mutatója, és megmutatja, mennyibe kerül, hogy 1000 egyedi felhasználó lássa a hirdetésedet.', tip: 'A CPR optimalizálásához szélesítsd a célzást és próbálj ki különböző kreatívokat. A Spark Ads formátum jellemzően alacsonyabb CPR-t ér el a natív megjelenés miatt.' },
  ttads_app_installs: { title: 'App telepítések', text: 'A hirdetés által generált alkalmazás-telepítések száma. Ez a fő konverziós mutató app-promóciós kampányoknál — közvetlenül méri a hirdetés hatékonyságát új felhasználók szerzésében.', tip: 'Az app telepítési kampányoknál a deep linking és az App Store oldal optimalizálása is kulcsfontosságú. A kreatívban mutasd be az app értékajánlatát és használd a UGC stílusú tartalmakat.' },
  ttads_payments: { title: 'Fizetés konverziók', text: 'A hirdetés által generált befejezett fizetések száma. Ez a végső konverziós mutató e-commerce hirdetéseknél — megmutatja, hányan vásároltak ténylegesen a hirdetés hatására.', tip: 'A ROAS mutató mellett figyeld a befejezett fizetések számát és az átlagos kosárértéket is. A remarketing kampányok és a dinamikus termékhirdetések növelhetik a konverziós arányt.' },
  ttads_registrations: { title: 'Regisztrációk', text: 'A hirdetés által generált regisztrációk száma. Ez fontos lead-generálási mutató, különösen SaaS és szolgáltató cégek számára.', tip: 'A regisztrációs konverziók növeléséhez egyszerűsítsd a regisztrációs folyamatot és használj erős ösztönzőket (ingyenes próba, kedvezmény). A landing page optimalizálása közvetlenül javítja a regisztrációs arányt.' },
  ttads_reach_total: { title: 'Elérés', text: 'A hirdetés által elért egyedi felhasználók összesített száma. Ez megmutatja, hány különböző emberhez jutott el a hirdetési üzeneted az adott időszakban.', tip: 'A szélesebb célzás és a nagyobb büdzsé növeli az elérést. A Reach & Frequency kampánytípus használatával kontrollálhatod, hányszor lássa egy felhasználó a hirdetésedet.' },
  // Facebook Organic
  ...
  fb_organic_impressions: { title: 'Organikus impressziók', text: 'Az organikus (nem fizetett) megjelenések száma az adott időszakban. Ez megmutatja, hogy a tartalmaid fizetett promóció nélkül hány megjelenést érnek el. Az organikus impressziók a tartalomstratégia természetes hatékonyságát mérik.', tip: 'Az organikus impressziók növeléséhez készíts olyan tartalmakat, amelyek interakcióra ösztönöznek — a Facebook algoritmusa az aktív engagement-et díjazza. A videó tartalmak és a natív formátumok jellemzően magasabb organikus elérést kapnak.' },
  fb_paid_impressions: { title: 'Fizetett impressziók', text: 'A fizetett hirdetésekből származó megjelenések száma. Ez megmutatja, mekkora részt tesz ki a hirdetési költés a teljes elérésedből. Az organikus és fizetett impressziók aránya fontos stratégiai mutató.', tip: 'Ha a fizetett impressziók aránya túl magas az organikushoz képest, az azt jelzi, hogy a tartalomstratégia fejlesztésre szorul. Az ideális arány 60-70% organikus / 30-40% fizetett.' },
  fb_page_actions_total: { title: 'Oldal akciók', text: 'Az oldalon végrehajtott akciók összesített száma (kattintások, CTA gombok, telefonhívások, útvonaltervezés). Ez a közönség aktív cselekvési szándékát méri, ami a legközvetlenebb üzleti értéket jelzi.', tip: 'A CTA gombok (Hívás, Útvonal, Weboldal) optimalizálása és a megfelelő kontaktadatok megadása növeli az akciószámot. A posztokban használt CTA-k szintén ide terelhetik a forgalmat.' },
  fb_reels_plays_total: { title: 'Reels lejátszások', text: 'A Facebook Reels tartalmak összesített lejátszási száma. A Reels az egyik leggyorsabban növekvő formátum Facebookon, és szélesebb elérést biztosít, mint a hagyományos posztok.', tip: 'A rövid, figyelemfelkeltő Reels-ek (15-30mp) teljesítenek a legjobban. Használj trendi hangokat, feliratot és erős vizuális hookot az első másodpercben. A vertikális formátum kötelező Reels esetén.' },
  // Instagram Organic
  ...
  yt_total_subs: { title: 'Összes feliratkozó', text: 'A csatorna aktuális teljes feliratkozó-száma. Ez a csatorna méretének és hitelességének egyik alapmutatója. A feliratkozószám befolyásolja a keresési pozíciót és a monetizációs lehetőségeket (1000 feliratkozó szükséges a YouTube Partner Programhoz).', tip: 'A feliratkozószám növeléséhez konzisztens minőségű tartalmak kellenek. Használj End Screen-eket és Cards-okat a feliratkozásra ösztönzéshez. A 100K feliratkozó elérésekor a YouTube Silver Play Button-t küld.' },
  yt_card_clicks_kpi: { title: 'Kártya kattintások', text: 'A videókban elhelyezett interaktív kártyák kattintásainak összesítése. A kártyák linkekre, lejátszási listákra vagy más videókra irányíthatják a nézőket, növelve a session watch time-ot és a konverziót.', tip: 'A kártyákat a videó tartalmához kapcsolódó pillanatokban helyezd el — amikor a néző éppen érdeklődik a témáról. Ne zsúfolj túl sok kártyát egy videóba; 2-3 jól elhelyezett kártya hatékonyabb, mint 5+ véletlenszerű.' },
  yt_card_ctr_kpi: { title: 'Kártya CTR%', text: 'A kártya-megjelenésekből kattintássá váló arány százalékban. Ez megmutatja, mennyire relevánsak és vonzóak a kártyáid a nézők számára. Magasabb CTR jobb kártya-elhelyezést és relevanciát jelez.', tip: 'Az 1-3% közötti kártya CTR normálisnak számít. A kártya szövegének vonzónak és relevánsnak kell lennie. Az időzítés kulcsfontosságú — a kártyát akkor mutasd, amikor a néző a leginkább érdeklődik.' },
  yt_red_watch: { title: 'Premium nézési idő', text: 'A YouTube Premium (korábbi YouTube Red) felhasználók által generált nézési idő percben. A Premium nézők jellemzően elkötelezettebbek és értékesebbek, mivel hirdetésmentes környezetben nézik a tartalmakat.', tip: 'A Premium nézők általában hosszabb nézési időt produkálnak. A minőségi, hosszabb tartalmak vonzzák a Premium közönséget. A Premium bevétel-megosztás is magasabb az átlagos hirdetési bevételnél.' },
};
  ...
  switch (platformKey) {
    case 'TIKTOK_ORGANIC': {
      ...
      return addDescriptions([
        ...
        { key: 'tt_daily_reached_total', label: 'Napi elért közönség', value: sumSeries(findChart(results, 'tt_daily_reached')) },
        { key: 'tt_engaged_total', label: 'Elkötelezett közönség', value: sumSeries(findChart(results, 'tt_engaged_audience')) },
